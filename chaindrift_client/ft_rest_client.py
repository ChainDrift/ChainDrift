"""
A Rest Client for Chaindrift bot
...
class FtRestClient:
    ...
    def pair_history(self, pair, timeframe, strategy, timerange=None, chainaimodel=None):
        """Return historic, analyzed dataframe

        :param pair: Pair to get data for
        :param timeframe: Only pairs with this timeframe available.
        :param strategy: Strategy to analyze and get values for
        :param chainaimodel: ChainAI model to use for analysis
