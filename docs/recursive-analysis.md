...
Why does this matter for Chaindrift? In backtesting, the bot will get full data of the pairs according to the timerange specified. But in a dry/live run, the bot will be limited by the amount of data each exchanges gives.
...
```
usage: chaindrift recursive-analysis [-h] [-v] [--logfile FILE] [-V] [-c PATH]
