...
from chaindrift.constants import FTHYPT_FILEVERSION
from chaindrift.exceptions import OperationalException
from chaindrift.optimize.hyperopt_tools import HyperoptTools, hyperopt_serializer
...
def test_try_export_params(default_conf, tmp_path, caplog, mocker):
    ...
    default_conf["user_data_dir"] = tmp_path
    export_mock = mocker.patch("chaindrift.optimize.hyperopt_tools.HyperoptTools.export_params")
