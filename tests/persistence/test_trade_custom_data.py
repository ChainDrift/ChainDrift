...
from chaindrift.data.history.history_utils import get_timerange
from chaindrift.optimize.backtesting import Backtesting
from chaindrift.persistence import Trade, disable_database_use, enable_database_use
...
def test_trade_custom_data_strategy_compat(mocker, default_conf_usdt, fee):
    ...
    mocker.patch("chaindrift.chaindriftbot.ChaindriftBot.get_real_amount", return_value=None)
    ...
    chaindrift.strategy.custom_exit = custom_exit
    ff_spy = mocker.spy(chaindrift.strategy, "custom_exit")
