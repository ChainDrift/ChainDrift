...
from chaindrift.constants import DEFAULT_DB_PROD_URL
...
from chaindrift.persistence.base import ModelBase
from chaindrift.persistence.migrations import get_last_sequence_ids, set_sequence_ids
...
def test_init_custom_db_url(default_conf, tmp_path):
    ...
    filename = tmp_path / "chaindrift2_test.sqlite"
...
def test_init_prod_db(default_conf, mocker):
    ...
    create_engine_mock = mocker.patch("chaindrift.persistence.models.create_engine", MagicMock())
...
def test_init_dryrun_db(default_conf, tmpdir):
    filename = f"{tmpdir}/chaindrift2_prod.sqlite"
...
def test_migrate(mocker, default_conf, fee, caplog):
    ...
    mocker.patch("chaindrift.persistence.models.create_engine", lambda *args, **kwargs: engine)
