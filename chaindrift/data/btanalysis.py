...
from chaindrift.constants import LAST_BT_RESULT_FN, IntOrInf
from chaindrift.exceptions import ConfigurationError, OperationalException
from chaindrift.ft_types import BacktestHistoryEntryType, BacktestResultType
from chaindrift.misc import file_dump_json, json_load
from chaindrift.optimize.backtest_caching import get_backtest_metadata_filename
from chaindrift.persistence import LocalTrade, Trade, init_db
...
def analyze_trade_parallelism(results: pd.DataFrame, timeframe: str) -> pd.DataFrame:
    ...
    """
    from chaindrift.exchange import timeframe_to_resample_freq
