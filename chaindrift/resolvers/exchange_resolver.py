...
import chaindrift.exchange as exchanges
from chaindrift.constants import Config, ExchangeConfig
from chaindrift.exchange import MAP_EXCHANGE_CHILDCLASS, Exchange
...
class ExchangeResolver(IResolver):
    ...
    def _load_exchange(exchange_name: str, kwargs: dict) -> Exchange:
        ...
        Only checks for exchanges exported in chaindrift.exchanges
                ...
                result.append(
                    {
                        ...
                        "location_rel: ": exchange.__module__.replace("chaindrift.", ""),
                    }
                )
        return result
