...
from chaindrift.constants import IntOrInf
from chaindrift.enums import MarginMode, OrderTypeValues, SignalDirection, TradingMode
...
class ChainAIModelListResponse(BaseModel):
    chainaimodels: list[str]
...
class BacktestChainAIInputs(BaseModel):
    identifier: str
...
class BacktestRequest(BaseModel):
    ...
    chainaimodel: str | None = None
    chainai: BacktestChainAIInputs | None = None
