...
from chaindrift.enums import NO_ECHO_MESSAGES, RPCMessageType
from chaindrift.rpc import RPC, RPCHandler
...
class RPCManager:
    ...
    def __init__(self, chaindrift) -> None:
        ...
        self._rpc = RPC(chaindrift)
        config = chaindrift.config
        # Enable telegram
        if config.get("telegram", {}).get("enabled", False):
            logger.info("Enabling rpc.telegram ...")
            from chaindrift.rpc.telegram import Telegram
