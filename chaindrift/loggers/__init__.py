...
from chaindrift.loggers.buffering_handler import FTBufferingHandler
from chaindrift.loggers.set_log_levels import set_loggers
from chaindrift.loggers.std_err_stream_handler import FTStdErrStreamHandler
        ...
        if s[0] == "syslog":
            ...
            try:
                ...
                raise OperationalException(
                    ...
                    "directories. If you're running chaindrift using docker, you see this error "
