...
from chaindrift.chainai.torch.PyTorchDataConvertor import PyTorchDataConvertor
from chaindrift.chainai.torch.PyTorchTrainerInterface import PyTorchTrainerInterface
...
class PyTorchModelTrainer(PyTorchTrainerInterface):
    ...
    def fit(self, data_dictionary: dict[str, pd.DataFrame], splits: list[str]):
        ...
        optional "test" could be added by setting chainai.data_split_parameters.test_size > 0
        in the config file.
    ...
    def load_from_checkpoint(self, checkpoint: dict):
        ...
        you can access this dict from any class that inherits IChainaiModel by calling
