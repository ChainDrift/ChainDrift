...
from chaindrift.chainai.base_models.BasePyTorchRegressor import BasePyTorchRegressor
from chaindrift.chainai.data_kitchen import ChainaiDataKitchen
from chaindrift.chainai.torch.PyTorchDataConvertor import (
    DefaultPyTorchDataConvertor,
    PyTorchDataConvertor,
)
from chaindrift.chainai.torch.PyTorchModelTrainer import PyTorchTransformerTrainer
from chaindrift.chainai.torch.PyTorchTransformerModel import PyTorchTransformerModel


class PyTorchTransformerRegressor(BasePyTorchRegressor):
    """
    This class implements the fit method of IChainaiModel.
    ...
    parameters are passed via `model_training_parameters` under the chainai
    ...
    def predict(
        self, unfiltered_df: pd.DataFrame, dk: ChainaiDataKitchen, **kwargs
