...
from chaindrift.commands.cli_options import AVAILABLE_CLI_OPTIONS
from chaindrift.constants import DEFAULT_CONFIG
...
ARGS_LIST_CHAINAIMODELS = ["chainaimodel_path", "print_one_column", "print_colorized"]
...
class Arguments:
    ...
    def _build_subcommands(self) -> None:
        ...
        self.parser = ArgumentParser(
            prog="chaindrift", description="Free, open source crypto trading bot"
        )
        ...
        # Add list-chainAI Models subcommand
        list_chainaimodels_cmd = subparsers.add_parser(
            "list-chainaimodels",
            help="Print available chainAI models.",
            parents=[_common_parser],
        )
        list_chainaimodels_cmd.set_defaults(func=start_list_chainAI_models)
        self._build_args(optionlist=ARGS_LIST_CHAINAIMODELS, parser=list_chainaimodels_cmd)
