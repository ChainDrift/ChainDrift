...
from chaindrift import __version__, constants
from chaindrift.constants import HYPEROPT_LOSS_BUILTIN
...
AVAILABLE_CLI_OPTIONS = {
    ...
    "ui_version": Arg(
        "--ui-version",
        help=(
            "Specify a specific version of ChainUI to install. "
    ...
    "chainaimodel": Arg(
        "--chainaimodel",
        help="Specify a custom chainaimodels.",
        metavar="NAME",
    ),
    "chainaimodel_path": Arg(
        "--chainaimodel-path",
        help="Specify additional lookup path for chainaimodels.",
        metavar="PATH",
    ),
    "chainai_backtest_live_models": Arg(
        "--chainai-backtest-live-models", help="Run backtest with ready models.", action="store_true"
    ),
