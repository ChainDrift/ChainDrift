...
from chaindrift.ft_types import ValidExchangesType
...
def start_list_exchanges(args: dict[str, Any]) -> None:
    ...
    if args["print_one_column"]:
        ...
        if args["list_exchanges_all"]:
            ...
            title = f"Exchanges available for Chaindrift ({len(available_exchanges)} exchanges):"
...
def start_list_chainAI_models(args: dict[str, Any]) -> None:
    """
    Print files with ChainAI models custom classes available in the directory
    """
    from chaindrift.configuration import setup_utils_configuration
    ...
    model_objs = ChainaiModelResolver.search_all_objects(config, not args["print_one_column"])
    # Sort alphabetically
...
def start_list_markets(args: dict[str, Any], pairs_only: bool = False) -> None:
    ...
    """
    from chaindrift.configuration import setup_utils_configuration
    from chaindrift.exchange import market_is_active
    from chaindrift.misc import plural
    from chaindrift.resolvers import ExchangeResolver
    from chaindrift.util import print_rich_table
...
def start_show_trades(args: dict[str, Any]) -> None:
    ...
    from chaindrift.configuration import setup_utils_configuration
    from chaindrift.misc import parse_db_uri_for_logging
    from chaindrift.persistence import Trade, init_db
