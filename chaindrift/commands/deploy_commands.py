...
from chaindrift.constants import USERPATH_STRATEGIES
...
def start_create_userdir(args: dict[str, Any]) -> None:
    ...
    :return: None
    """
    from chaindrift.configuration.directory_operations import copy_sample_files, create_userdata_dir
...
def deploy_new_strategy(strategy_name: str, strategy_path: Path, subtemplate: str) -> None:
    ...
    """
    from chaindrift.util import render_template, render_template_with_fallback
...
def start_install_ui(args: dict[str, Any]) -> None:
    ...
    if curr_version == latest_version and not args.get("erase_ui_only"):
        logger.info(f"UI already up-to-date, ChainUI Version {curr_version}.")
        return
