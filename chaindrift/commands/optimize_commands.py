...
def setup_optimize_configuration(args: dict[str, Any], method: RunMode) -> dict[str, Any]:
    ...
    from chaindrift.util import fmt_coin
...
def start_backtesting(args: dict[str, Any]) -> None:
    ...
    logger.info("Starting chaindrift in Backtesting mode")
...
def start_backtesting_show(args: dict[str, Any]) -> None:
    ...
    from chaindrift.optimize.optimize_reports import show_backtest_results, show_sorted_pairlist
...
def start_hyperopt(args: dict[str, Any]) -> None:
    ...
    logger.info("Starting chaindrift in Hyperopt mode")
    ...
    try:
        ...
        logger.info("Another running instance of chaindrift Hyperopt detected.")
        logger.info(
        ...
        # TODO: return False here in order to help chaindrift to exit
...
def start_edge(args: dict[str, Any]) -> None:
    ...
    :return: None
    """
    from chaindrift.optimize.edge_cli import EdgeCli

    # Initialize configuration
    config = setup_optimize_configuration(args, RunMode.EDGE)
    logger.info("Starting chaindrift in Edge mode")
...
def start_lookahead_analysis(args: dict[str, Any]) -> None:
    ...
    """
    from chaindrift.configuration import setup_utils_configuration
    from chaindrift.optimize.analysis.lookahead_helpers import LookaheadAnalysisSubFunctions
...
def start_recursive_analysis(args: dict[str, Any]) -> None:
    ...
    """
    from chaindrift.configuration import setup_utils_configuration
    from chaindrift.optimize.analysis.recursive_helpers import RecursiveAnalysisSubFunctions
