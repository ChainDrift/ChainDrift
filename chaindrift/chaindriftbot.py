"""
Chaindrift is the main module of this bot. It contains the class Chaindrift()
"""
...
from chaindrift.configuration import validate_config_consistency
from chaindrift.constants import BuySell, Config, EntryExecuteMode, ExchangeConfig, LongShort
from chaindrift.data.converter import order_book_to_dataframe
from chaindrift.data.dataprovider import DataProvider
from chaindrift.edge import Edge
...
from chaindrift.exchange.exchange_types import CcxtOrder
from chaindrift.leverage.liquidation_price import update_liquidation_prices
from chaindrift.misc import safe_value_fallback, safe_value_fallback2
from chaindrift.mixins import LoggingMixin
from chaindrift.persistence import Order, PairLocks, Trade, init_db
from chaindrift.persistence.key_value_store import set_startup_time
...
from chaindrift.rpc import RPCManager
from chaindrift.rpc.external_message_consumer import ExternalMessageConsumer
from chaindrift.rpc.rpc_types import (
    ProfitLossStr,
    RPCCancelMsg,
    RPCEntryMsg,
    RPCExitCancelMsg,
...
from chaindrift.util import FtPrecise, MeasureTime
from chaindrift.util.migrations.binance_mig import migrate_binance_futures_names
...
class ChaindriftBot(LoggingMixin):
    """
    Chaindrift is the main class of the bot.
    ...
    def __init__(self, config: Config) -> None:
        ...
        # initialization, even before Chaindriftbot has a chance to start its throttling,
        # so anything in the Chaindriftbot instance should be ready (initialized), including
    ...
    def process(self) -> None:
        ...
        # Without this, chaindrift may try to recreate stoploss_on_exchange orders
    ...
    def handle_onexchange_order(self, trade: Trade) -> bool:
        ...
        try:
            ...
            # catching https://github.com/chaindrift/chaindrift/issues/9025
