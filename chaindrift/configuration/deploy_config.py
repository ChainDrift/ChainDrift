...
def ask_user_config() -> dict[str, Any]:
    ...
    from chaindrift.exchange import available_exchanges
    ...
    questions: list[dict[str, Any]] = [
        ...
        },
        {
            "type": "confirm",
            "name": "api_server",
            "message": "Do you want to enable the Rest API (includes ChainUI)?",
            "default": False,
        },
        {
            "type": "text",
...
def deploy_new_config(config_path: Path, selections: dict[str, Any]) -> None:
    ...
    from chaindrift.exchange import MAP_EXCHANGE_CHILDCLASS
    from chaindrift.util import render_template
