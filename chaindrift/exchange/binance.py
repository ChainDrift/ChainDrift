...
from chaindrift.enums import CandleType, MarginMode, PriceType, TradingMode
from chaindrift.exceptions import DDosProtection, OperationalException, TemporaryError
from chaindrift.exchange import Exchange
from chaindrift.exchange.common import retrier
from chaindrift.exchange.exchange_types import FtHas, OHLCVResponse, Tickers
from chaindrift.misc import deep_merge_dicts, json_load
...
class Binance(Exchange):
    ...
    def funding_fee_cutoff(self, open_date: datetime):
        ...
        https://github.com/chaindrift/chaindrift/pull/5779#discussion_r740175931
