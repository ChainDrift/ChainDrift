...
from chaindrift.constants import ExchangeConfig
from chaindrift.exceptions import DDosProtection, RetryableOrderError, TemporaryError
            ...
            if count > 0:
                ...
                if isinstance(ex, DDosProtection):
                    if kucoin and "429000" in str(ex):
                        ...
                        # see https://github.com/chaindrift/chaindrift/issues/5700 for details.
