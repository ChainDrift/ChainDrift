...
from chaindrift.enums import MarginMode, TradingMode
...
from chaindrift.exchange.exchange_types import CcxtBalances, FtHas, Tickers
...
class Kraken(Exchange):
    ...
    def calculate_funding_fees(
        ...
        """
        # ! This method will always error when run by Chaindrift because time_in_ratio is never
