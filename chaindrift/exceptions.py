class ChaindriftException(Exception):
    """
    Chaindrift base exception. Handled at the outermost level.
    All other exception types are subclasses of this exception type.
    """


class OperationalException(ChaindriftException):
    """
...
class DependencyException(ChaindriftException):
    """
...
class StrategyError(ChaindriftException):
    """
