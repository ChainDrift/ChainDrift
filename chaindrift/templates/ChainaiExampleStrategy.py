...
class ChainaiExampleStrategy(IStrategy):
    """
    Example strategy showing how the user connects their own
    IChainaiModel to the strategy.

    Warning! This is a showcase of functionality,
    which means that it is designed to show various functions of ChainAI
    ...
    def set_chainai_targets(self, dataframe: DataFrame, metadata: dict, **kwargs) -> DataFrame:
        ...
        *Only functional with ChainAI enabled strategies*
        ...
        # chainai/prediction_models/CatboostRegressorMultiTarget.py,
        # chaindrift trade --chainaimodel CatboostRegressorMultiTarget
