...
from chaindrift.optimize.base_analysis import BaseAnalysis, VarHolder
...
class LookaheadAnalysis(BaseAnalysis):
    ...
    def prepare_data(self, varholder: VarHolder, pairs_to_load: list[DataFrame]):
        if "chainai" in self.local_config and "identifier" in self.local_config["chainai"]:
            # purge previous data if the chainai model is defined
            ...
            path_to_current_identifier = Path(
                ...
                f"{self.local_config['chainai']['identifier']}"
            ).resolve()
