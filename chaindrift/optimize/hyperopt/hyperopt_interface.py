...
from chaindrift.misc import round_dict
...
class IHyperOpt(ABC):
    """
    Interface for chaindrift hyperopt
    ...
    def roi_space(self) -> list[Dimension]:
        ...
        It's used by Chaindrift by default, if no custom roi_space method is defined.
        """
        ...
        #
        # The scaling is designed so that it maps exactly to the legacy Chaindrift roi_space()
