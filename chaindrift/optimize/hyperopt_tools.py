...
from chaindrift.constants import FTHYPT_FILEVERSION, Config
from chaindrift.enums import HyperoptState
from chaindrift.exceptions import OperationalException
from chaindrift.misc import deep_merge_dicts, round_dict, safe_value_fallback2
from chaindrift.optimize.hyperopt_epoch_filters import hyperopt_filter_epochs
        ...
        for epochs_tmp in HyperoptTools._read_results(results_file):
            if total_epochs == 0 and epochs_tmp[0].get("is_best") is None:
                raise OperationalException(
                    ...
                    "of Chaindrift and cannot be loaded."
                )
